        ...
        <?php echo $form->renderHiddenFields() ?>
				<div class="a-form-row submit">
					<ul class="a-ui a-controls">
						...
						<li><?php echo link_to('<span class="icon"></span>'.a_('Reset'), 'a_user_admin_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'a-btn icon a-cancel alt')) ?></li>
					</ul>
				</div>
