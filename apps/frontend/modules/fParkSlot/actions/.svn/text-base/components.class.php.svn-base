<?php
class fParkSlotComponents extends BaseaSlotComponents
{
  public function executeEditView()
  {
    ...
    if (!isset($this->form))
    {
      $this->form = new fParkSlotEditForm($this->id, $this->slot->getArrayValue());
    }
  }
  public function executeNormalView()
  {
    ...
    else
    {
      ...
      $this->itemId = $i->id;
      $this->embed = $i->getEmbedCode(160,130,'c',$i->format,false);
    }    
