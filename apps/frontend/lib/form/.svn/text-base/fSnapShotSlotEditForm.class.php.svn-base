<?php    
class fSnapShotSlotEditForm extends BaseForm
{
  ...
  public function configure()
  {
    ...
    $align_choices =array('left' => "Left", 'right' => "Right");
    $this->setWidgets(array(
      'url' => new sfWidgetFormInputText(array(), array('class' => 'fParkSlot')),
      'title' => new sfWidgetFormInputText(),
      'text' => new sfWidgetFormTextarea(),
      'align' => new sfWidgetFormChoice(array(
          'expanded' => true,
    ...
    $this->setValidators(array(
      ...
      'align' => new sfValidatorChoice(array('required' => true,'choices' => array_keys($align_choices))),
      ));
